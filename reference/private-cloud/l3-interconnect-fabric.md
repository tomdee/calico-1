...
discussed in our earlier [technical note]({{site.baseurl}}/reference/private-cloud/l2-interconnect-fabric).
...
detailed in [this post]({{site.baseurl}}/reference/private-cloud/l2-interconnect-fabric).
...
and the [Ethernet fabric note]({{site.baseurl}}/reference/private-cloud/l2-interconnect-fabric),
...
In the {{site.prodname}} [Ethernet fabric]({{site.baseurl}}/reference/private-cloud/l2-interconnect-fabric)
...
In the [Ethernet fabric]({{site.baseurl}}/reference/private-cloud/l2-interconnect-fabric)
