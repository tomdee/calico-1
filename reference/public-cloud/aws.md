...
See the [IP pool configuration reference]({{site.baseurl}}/reference/calicoctl/resources/ippool)
...
> is configured correctly, follow the [Configuring IP-in-IP guide]({{site.baseurl}}/usage/configuration/ip-in-ip)
...
you must configure outgoing NAT on your [{{site.prodname}} IP pool]({{site.baseurl}}/reference/calicoctl/resources/ippool).
