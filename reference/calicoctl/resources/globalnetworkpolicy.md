...
`GlobalNetworkPolicy` is not a namespaced resource. `GlobalNetworkPolicy` applies to [workload endpoint resources]({{site.baseurl}}/reference/calicoctl/resources/workloadendpoint) in all namespaces, and to [host endpoint resources]({{site.baseurl}}/reference/calicoctl/resources/hostendpoint).
...
See [network policy resource]({{site.baseurl}}/reference/calicoctl/resources/networkpolicy) for namespaced network policy.
...
only when applying policy to a [host endpoint]({{site.baseurl}}/reference/calicoctl/resources/hostendpoint).
...
[workload endpoint]({{site.baseurl}}/reference/calicoctl/resources/workloadendpoint),
