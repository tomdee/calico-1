...
[node resource configuration]({{site.baseurl}}/reference/calicoctl/resources/node)
...
in the cluster, see [decomissioning a node]({{site.baseurl}}/usage/decommissioning-a-node).
