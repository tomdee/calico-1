...
See the [BGP peering document]({{site.baseurl}}/usage/configuration/bgp)
...
There's further advice on network topologies in the [private cloud reference documentation]({{site.baseurl}}/reference/).
